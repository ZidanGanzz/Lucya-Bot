...
const msgHndlr = require ('./NaisaZidan')
...
nocache('./NaisaZidan.js', module => console.log(`${module} Updated!`))
require('./lib/help.js')
...
const start = async(aksa = new Client()) => {
    ...
    aksa.onMessage((async(message) => {
        ...
        require('./NaisaZidan.js')(aksa, message)
    }))


    aksa.onGlobalParticipantsChanged((async (heuh) => {
